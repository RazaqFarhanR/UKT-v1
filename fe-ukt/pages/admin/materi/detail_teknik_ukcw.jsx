...
const detail_teknik_ukcw = () => {
    ...
    const getDataTeknik = () => {
        ...
        axios.get (BASE_URL + `teknik/ukt/UKCW`, { headers: { Authorization: `Bearer ${token}`}})
        .then (res => {
                    ...
                    <div className="min-h-full bg-darkBlue p-6">
                        ...
                        <div className="flex justify-between items-center text-white mb-7">
                            ...
                            <div className="flex justify-center items-center gap-x-3">
                                ...
                                <h1 className='text-2xl tracking-wider'>Teknik - UKCW</h1>
                            </div>
...
export default detail_teknik_ukcw
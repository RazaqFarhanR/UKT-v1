            ...
            <div className="flex font-lato">
                ...
                <div className="w-full overflow-y-auto h-screen">
                    ...
                    <div className="min-h-full bg-darkBlue p-6">
                        ...
                        {/* wrapper kategori */}
                        <div className="grid grid-cols-12 gap-x-3 text-white font-semibold text-lg">
                            ...
                            <div className="col-span-2 bg-navy rounded-md flex items-center justify-center gap-x-2">
                                <div className="bg-green hover:bg-white duration-300 p-1.5 rounded-md flex items-center group">

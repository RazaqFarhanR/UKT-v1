...
const modal_ukt_teknik = () => {

    // state modal
    const {showModalUktTeknik, setShowModalUktTeknik} = useContext (globalState)

    // state
    const {action, idTeknik, setDataTeknik, ukt} = useContext (globalState)
    const {teknikName ,setTeknikName} = useContext (globalState)
                            ...
                            <div className="relative bg-navy text-white rounded-lg shadow">
                                <form action="POST" onSubmit={handleSave}>
                                    ...
                                    <div className="flex justify-center p-4">
                                        ...
                                        <button onClick={() => setShowModalUktTeknik(false)} type="button" className="p-1.5 inline-flex items-center absolute right-5">
                                    ...
                                    <div className="px-6 py-2 space-y-3">
                                        ...
                                        <div className="flex flex-row space-x-3 w-full">
                                            ...
                                            <div className="w-4/6">
                                                ...
                                                type="text"
                                                value={teknikName}
                                                onChange={(e) => setTeknikName(e.target.value)}
                                                required
                                                >        
                                                </input>
                                            </div>
                                    ...
                                    <div className="flex items-center justify-end p-6 space-x-2">
                                        <button onClick={() => setShowModalUktTeknik(false)} className="text-red hover:text-white bg-white hover:bg-red duration-300 font-medium rounded-lg px-5 py-2.5 text-center">Cancel</button>
                                        {(() => {
                                            if (action === 'insert') {
                                                return (
...
export default modal_ukt_teknik
                ...
                <div className="min-h-full bg-darkBlue p-6">
                    ...
                    <div className="flex justify-between items-center text-white mb-7">
                        ...
                        <div className="flex justify-center items-center gap-x-3">
                            ...
                            <h1 className='text-2xl tracking-wider'>Penguji Cabang</h1>
                        </div>
                                ...
                                {dataPengujiCabang.filter(a => a.id_role === 'penguji cabang').map ((item, index) => (
                                    <tr key={index + 1} className='text-white text-center'>
                                        ...
                                        <td className='border-b-2 border-gray p-3'>
                                            <img className='rounded-lg object-cover w-28 h-28' src={IMAGE_URL + item.image.split('http://localhost:8080/image/')[1]} alt="" />
                                        </td>

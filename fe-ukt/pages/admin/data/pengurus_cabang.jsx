...
const pengurus_cabang = () => {
    ...
    // state
    const [dataPengurusCabang, setDataPengurusCabang] = useState ([])
    const [action, setAction] = useState ('')
    const [idPengurusCabang, setIdPengurusCabang] = useState ('')
    ...
    // function modal add
    const addModal = () => {
        setShowModalPengurusCabang (true)
        setAction ('insert')
        setNiw ('')
        setName ('')
        setJabatan ('')
    ...
    const editModal = (selectedItem) => {
        setShowModalPengurusCabang (true)
        setAction ('update')
        setIdPengurusCabang (selectedItem.id_pengurus)
    ...
    return (
        <>
                    ...
                    <div className="min-h-full bg-darkBlue p-6">
                        ...
                        <div className="flex justify-between items-center text-white mb-7">
                            ...
                            <div className="flex justify-center items-center gap-x-3">
                                ...
                                <h1 className='text-2xl tracking-wider'>Pengurus Cabang</h1>
                            </div>
                        ...
                        <div className="bg-navy rounded-md py-2 px-3">
                            ...
                            <table className='w-full table-fixed'>
                                ...
                                <tbody>
                                    {dataPengurusCabang.filter(a => a.id_role === 'pengurus cabang').map ((item, index) => (
            ...
            {/* memanggil modal */}
            <globalState.Provider value={{ showModalPengurusCabang, setShowModalPengurusCabang, dataPengurusCabang, setDataPengurusCabang, action, setAction, idPengurusCabang, niw, setNiw, name, setName, jabatan, setJabatan, ranting, setRanting, username, setUsername, password, setPassword, role, foto, setFoto }}>
                <Modal_pengurus_cabang />
            </globalState.Provider>

            <globalState.Provider value={{ showModalDelete, setShowModalDelete, dataPengurusCabang, setDataPengurusCabang, action, idPengurusCabang }}>
                <Modal_delete />
            </globalState.Provider>
        </>
...
export default pengurus_cabang
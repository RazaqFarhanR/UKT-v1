                    ...
                    <tbody>
                        <tr className='text-white text-center'>
                            ...
                            <td className='border-b-2 border-gray'>
                                <button onClick={() => addModal()} className="bg-purple hover:bg-white hover:text-purple py-2 px-3 rounded-md w-32 flex justify-center items-center space-x-2 mx-auto group duration-300">

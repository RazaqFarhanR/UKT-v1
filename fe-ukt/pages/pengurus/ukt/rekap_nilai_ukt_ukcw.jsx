...
const rekap_nilai_ukt_jambon = () => {
    const [dataUKCW, setDataUKCW] = useState([])
    const getDataUKCW = () => {
        const token = localStorage.getItem('token')

        axios.get(BASE_URL + `ukt_siswa/ukt/UKCW`, { headers: { Authorization: `Bearer ${token}` } })
            .then(res => {
                console.log(res.data.data);
                setDataUKCW(res.data.data)
            })
            .catch(err => {
                    ...
                    <div className="min-h-full bg-darkBlue p-6">
                        ...
                        <div className="flex justify-between items-center text-white mb-7">
                            ...
                            <div className="flex justify-center items-center gap-x-3">
                                ...
                                <h1 className='text-2xl tracking-wider'>Rekap Nilai - UKCW 2023</h1>
                            </div>
